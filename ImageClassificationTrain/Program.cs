...
namespace ImageClassificationTrain
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            TryMultiPrediction(imagesFolderPathForPredictions, mlContext, trainedModel);
        ...
        private static void TryMultiPrediction(string imagesFolderPathForPredictions, MLContext mlContext, ITransformer trainedModel)
        {
            // Create prediction function to try one prediction
            var predictionEngine = mlContext.Model
                .CreatePredictionEngine<InMemoryImageData, ImagePrediction>(trainedModel);
